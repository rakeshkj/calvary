    ...
    render() {
        ...
        return (
            <View style={{flex: 1, justifyContent: 'center', backgroundColor: 'black'}}>
                <Text style={{color:'white',marginTop:-50}}>{this.props.navigation.state.params.title}</Text>
                <Image source={{uri:this.props.navigation.state.params.image}} style={{width: 150, height: 150, marginBottom: 15, alignSelf: 'center'}}/>
                ...
                <View style={{marginVertical: 15, marginHorizontal: 15, flexDirection: 'row'}}>
                    ...
                    <Slider
                        ...
                        minimumTrackTintColor='white' thumbTintColor='white'
